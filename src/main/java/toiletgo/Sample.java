...
/**
 * <h3>Sample : 샘플 데이터 삽입</h3>
 * <b>실제 데이터 완성되면 @Component 빼 주세요 </b>
 */
...
public class Sample implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("Toiletgo Sample data insert");
        ...
        Toilet toilet1 = new Toilet("강남구 테헤란로 지하 538", new BigDecimal("37.508928"), new BigDecimal("127.063370"), new BigDecimal(3.51) );
